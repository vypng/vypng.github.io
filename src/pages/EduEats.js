            ...
            <Col md={3} style={{ paddingTop: "130px", paddingLeft: "70px", position: "relative", width: "20%"}} className="d-none d-md-block">
                ...
                <ul className='toc-list'>
                    <li style={{ borderTop: "2px solid #BEBCBE"}} className="toc-item">
                        ...
                        <button  onClick={() => scrollToSection("#area-of-concern")} className="toc-section">The Area of Concern</button>
                    </li>
                    <li className="toc-item">
                        <span className="toc-number">2</span> 
                        <button  onClick={() => scrollToSection("#researching")} className="toc-section">Researching</button>
                    </li>
                    <li className="toc-item">
                    ...
                    <li className="toc-item">
                        ...
                        <button  onClick={() => scrollToSection("#solution")} className="toc-section">Solution</button>
                    </li>
                    <li className="toc-item">
          ...
          <div id="researching" className="section">
            <Container>
              ...
              <div className="project-section-margins">
                ...
                <p style={{marginTop: "150px", marginBottom: "40px"}}>I also conducted interviews with five college students across the United States to gather sentiments regarding the issue.</p>
                ...
                <p className="description-text">26 students rated each tool on a scale from 1-10, 1 being least valuable and 10 being most valuable.</p>
